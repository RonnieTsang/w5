...
def api_get_workflow_exec():
    if request.method == "POST":
        ...
        from core.module.workflow.view import get_workflow_exec
...
def api_get_workflow_sucess_fail():
    if request.method == "POST":
        ...
        from core.module.workflow.view import get_workflow_success_fail
...
def api_get_workflow_logs():
    if request.method == "POST":
        ...
        from core.module.workflow.view import get_workflow_logs
